...
$sqlprodutocafe = "SELECT * FROM produtos WHERE tipo = 'Café'";
$statement = $pdo -> query($sqlprodutocafe);
$produtosCafe = $statement -> fetchAll(PDO:: FETCH_ASSOC);

$sqlprodutosAlmoco = "SELECT * FROM produtos WHERE tipo = 'Almoço'";
$statement = $pdo -> query($sqlprodutosAlmoco);
